...
with tab_photo:
    ...
    with col_opt:
        ...
        line_pos_p = st.slider("Position (%)", 10, 90, 50, key="lpp",
...
with tab_video:
    ...
    if upl_v:
        ...
        with cc_:
            ...
            line_pos_v = st.slider("Position (%)", 10, 90, 50, key="lpv",
        ...
        if st.button("▶️ Lancer l'analyse"):
            ...
            try:
                ...
                st.error("Dépendance manquante : imageio[ffmpeg]"); st.stop()
            ...
            render_counters({}, dict(st.session_state.cumul_ids),
...
with tab_cam:
    ...
    line_pos_c = st.slider("Position (%)", 10, 90, 50, key="lpc",
